 ...
 */
final class Version20200105002609 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE naissance (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE etudiants CHANGE niveau_id niveau_id INT DEFAULT NULL, CHANGE naissance naissance VARCHAR(255) NOT NULL');
