 ...
 */
final class Version20200104233148 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE etudiants CHANGE niveau_id niveau_id INT DEFAULT NULL, CHANGE naissance naissance DATETIME NOT NULL');
