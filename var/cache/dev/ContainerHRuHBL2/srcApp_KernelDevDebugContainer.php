...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\QueryController' => 'getQueryControllerService',
    ...
    /**
     * Gets the public 'App\Controller\QueryController' shared autowired service.
     *
     * @return \App\Controller\QueryController
     */
    protected function getQueryControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/QueryController.php';

        $this->services['App\\Controller\\QueryController'] = $instance = new \App\Controller\QueryController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\QueryController', $this));
