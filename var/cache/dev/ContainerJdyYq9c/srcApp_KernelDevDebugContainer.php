...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getNoteControllerService()
    {
        ...
        $this->services['App\\Controller\\NoteController'] = $instance = new \App\Controller\NoteController(($this->privates['App\\Repository\\NoteRepository'] ?? $this->getNoteRepositoryService()));

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\NoteController', $this));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('lh24OPS6xl', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QJsfuPE-Qx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    /**
     * Gets the private '.errored..service_locator.LW74jiC.App\Entity\Note' shared service.
     *
     * @return \App\Entity\Note
     */
    protected function getNoteService()
    {
        include_once \dirname(__DIR__, 4).'/src/Entity/Note.php';

        return $this->privates['.errored..service_locator.LW74jiC.App\\Entity\\Note'] = new \App\Entity\Note();
    }
    ...
    /**
     * Gets the private '.service_locator.LW74jiC' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_LW74jiCService()
    {
        return $this->privates['.service_locator.LW74jiC'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'Note' => ['privates', '.errored..service_locator.LW74jiC.App\\Entity\\Note', NULL, 'Cannot autowire service ".service_locator.LW74jiC": it references class "App\\Entity\\Note" but no such service exists.'],
        ], [
    ...
    /**
     * Gets the private '.service_locator.NPtNR._' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_NPtNR_Service()
    {
        return $this->privates['.service_locator.NPtNR._'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\EtudiantController::show' => ['privates', '.service_locator.pIUQkC7', 'get_ServiceLocator_PIUQkC7Service', false],
            'App\\Controller\\NoteController::show' => ['privates', '.service_locator.LW74jiC', 'get_ServiceLocator_LW74jiCService', false],
            'App\\Controller\\EtudiantController:show' => ['privates', '.service_locator.pIUQkC7', 'get_ServiceLocator_PIUQkC7Service', false],
            'App\\Controller\\NoteController:show' => ['privates', '.service_locator.LW74jiC', 'get_ServiceLocator_LW74jiCService', false],
        ], [
    ...
    /**
     * Gets the private 'App\Form\NoteSearchType' shared autowired service.
     *
     * @return \App\Form\NoteSearchType
     */
    protected function getNoteSearchTypeService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/AbstractType.php';
        include_once \dirname(__DIR__, 4).'/src/Form/NoteSearchType.php';

        return $this->privates['App\\Form\\NoteSearchType'] = new \App\Form\NoteSearchType();
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5w8KBpETB5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('J3HrdfWkN2', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+9Fzf81jXe', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CUXUMYzRyv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6z7akMsFzh', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.NPtNR._'] ?? $this->get_ServiceLocator_NPtNR_Service())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getForm_RegistryService()
    {
        ...
        return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Form\\NoteSearchType' => ['privates', 'App\\Form\\NoteSearchType', 'getNoteSearchTypeService', false],
